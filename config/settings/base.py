...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "jobs.Job": "fas fa-id-badge",
        "category": "fas fa-folder-open",
        "category.Category": "fas fa-folder",
        "skills": "fas fa-lightbulb",
        "skills.Skill": "fas fa-wrench",
        "language": "fas fa-language",
        "language.Locale": "fas fa-globe",
